...
describe('Import toile test', () => {
    ...
    let archive_filename = path.join(__dirname,'/archive/2021/02/07/2021-02-07_00-00-16-toile.png');
    let thumbnail_filename = path.join(__dirname,'/thumbnail/2021/02/07/2021-02-07_00-00-16-toile.png');
    let symlink_geocoding_filename =  "";
    let symlink_photo_filename = path.join(__dirname, '/photos/folder1/2021-02-07_00-00-16-toile.png');
    ...
    beforeEach(async () => {
        ...
        filename= path.join('folder1','toile.png');
